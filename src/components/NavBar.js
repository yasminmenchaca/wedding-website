...
const NavBar = () => {
    return (
        <ReactBootStrap.Navbar collapseOnSelect expand="xl" variant="light" fixed="top"
                               style={{backgroundColor: 'white'}}>
            <ReactBootStrap.Navbar.Brand href="/" style={{fontWeight: 'bold'}}>Lynn &
                Yasmin</ReactBootStrap.Navbar.Brand>
            ...
            <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
                ...
                <ReactBootStrap.Nav>
                    ...
                    <ReactBootStrap.Nav.Link href="/watch">Watch
                        Online</ReactBootStrap.Nav.Link>
                    </Link>
