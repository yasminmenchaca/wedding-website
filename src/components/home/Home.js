    ...
    return (
        <div>
            ...
            <div className='text-center' style={{backgroundColor: 'white', padding: '50px 50px'}}>
                ...
                <h6>In light of COVID-19, we wanted to let you know our wedding is going forward as planned. As always,
                    ...
                    We have reached out to those who are able to join us.</h6>
            </div>
