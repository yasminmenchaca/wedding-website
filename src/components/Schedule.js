        ...
        <ReactBootStrap.Container fluid
            ...
            <ReactBootStrap.Row>
                <ReactBootStrap.Col sm={6} className='align-self-center'>
                    ...
                    <h5>2:00 PM - 6:00 PM CST</h5> <br className='d-md-none'/> <br className='d-md-none'/>
                </ReactBootStrap.Col>
                ...
                <ReactBootStrap.Col sm={6} className='align-self-center'>
                    ...
                    <h5>Alamo Drafthouse - Stone Oak <br/>
                        ...
                        <b>For everyone’s safety, guests will be required to wear masks at all times, except when eating
                            or drinking. Alamo Drafthouse will also check the temperature of guests as they arrive. </b><br/><br/>
                        <a href="https://drafthouse.com/san-antonio/covid-safety" className="btn btn-dark btn-lg"
                           role="button" target="_blank">Venue Policy</a></h5>
                </ReactBootStrap.Col>
