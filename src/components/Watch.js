    ...
    return (
        <HttpsRedirect>
            <ReactBootStrap.Container fluid
                ...
                <h1 style={{fontWeight: 'bold'}}>Watch Online</h1>
                ...
                <a href="https://www.twitch.tv/yasminismean" className="btn btn-dark btn-lg" target="_blank"
                   role="button">Click Here to Watch Online</a>
